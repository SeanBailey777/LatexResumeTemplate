...
\summary{Experienced software developer with 3+ years of experience seeking a backend or full-stack development role. Proven in enhancing customer satisfaction and driving business growth. Committed to continuous learning and delivering efficient solutions.}
...
\skills{
    ...
    \skillItem[
        ...
        skills=Linux{,} git{,} docker{,} RESTful{,} Distributed Systems{,} Parallel computing{,} Functional Programming{,} Flask{,} Arduino{,}\\   
    ]
    % \skillItem[
...
\begin{workSection}{Experience}
    ...
    \begin{itemize}
        ...
        \item My students achieved the top 5-20\% rankings in the pre-College programming test (APCS). Taught students about robot development with Arduino, Tinker Cad, and Micro Bit at universities.
     \end{itemize}
